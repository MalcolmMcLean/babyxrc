...
extern "C" {
	...
	EXPORT_DEF Long TT_LookUp_Table(PFace face, ULong tag);

	LOCAL_DEF TT_Error Load_TrueType_Directory(PFace face, ULong faceIndex);
	...
	LOCAL_DEF TT_Error Load_TrueType_Any(PFace face, ULong tag, Long offset, void *buffer, Long * length);
